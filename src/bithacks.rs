// Given a 32-bit number, find the highest bit number which is set.
// e.g. if n is 0011(base 2), then c will be 1.
#[inline]
...
// e.g. if n is 7, then function will return (8, 3), which 8 = 1 << 3
#[inline]
